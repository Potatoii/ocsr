...
for file_in in args.file:
    ...
    def main():
        ...
        logger.info("Total number of selected SMILES Strings: ", len(train_captions), "\n")
    ...
    def get_train_tfrecord(num_shards, train_captions, img_name_vector, file_index):
        logger.info("Total number of TFrecords: ", num_shards, flush=True)
        ...
        for i in range(num_shards):
            ...
            logger.info("%s write to tfrecord success!" % tfrecord_name, flush=True)
