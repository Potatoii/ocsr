...
def apply_masks(image: np.array, masks: np.array) -> tuple[List[np.array], List]:
    """
...
def main():
    ...
    logger.info("Segmenting structures...")
    ...
    logger.info(f"The segmented images can be found in {segment_dir}")
