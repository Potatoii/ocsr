...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    if image_path:
        ...
        logger.info("Running on {}".format(args.image))
        # Read image
...
if __name__ == "__main__":
    ...
    logger.info("Weights: ", args.weights)
    logger.info("Dataset: ", args.dataset)
    logger.info("Logs: ", args.logs)
    ...
    if args.command == "train":
        ...
        logger.info("'{}' is not recognized. " "Use 'train' or 'splash'".format(args.command))
